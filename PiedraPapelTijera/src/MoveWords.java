...
public class MoveWords {
	...
	public static int checkWinner(String first, String second) {
		...
		if (first_i == 0 && second_i == 1) {
			return GANA;
		} else if (first_i == 0 && second_i == 2) {
			return PIERDE;
		} else if (first_i == 0 && second_i == 3) {
			return GANA;
		} else if (first_i == 0 && second_i == 4) {
			return PIERDE;
		} else if (first_i == 1 && second_i == 0) {
			return PIERDE;
		} else if (first_i == 1 && second_i == 2) {
			return GANA;
		} else if (first_i == 1 && second_i == 3) {
			return PIERDE;
		} else if (first_i == 1 && second_i == 4) {
			return GANA;
		} else if (first_i == 2 && second_i == 0) {
			return GANA;
		} else if (first_i == 2 && second_i == 1) {
			return PIERDE;
		} else if (first_i == 2 && second_i == 3) {
			return GANA;
		} else if (first_i == 2 && second_i == 4) {
			return PIERDE;
		} else if (first_i == 3 && second_i == 0) {
			return PIERDE;
		} else if (first_i == 3 && second_i == 1) {
			return GANA;
		} else if (first_i == 3 && second_i == 2) {
			return PIERDE;
		} else if (first_i == 3 && second_i == 4) {
			return GANA;
		} else if (first_i == 4 && second_i == 0) {
			return GANA;
		} else if (first_i == 4 && second_i == 1) {
			return PIERDE;
		} else if (first_i == 4 && second_i == 2) {
			return GANA;
		} else if (first_i == 4 && second_i == 3) {
			return PIERDE;
		} else {
			return EMPATE;
		}
